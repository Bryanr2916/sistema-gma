...
@Component({
  selector: 'app-admin-permisos-edit',
  templateUrl: './edit.component.html',
  styleUrls: ['./edit.component.scss']
})
export class AdminPermisosEditComponent implements OnInit {
  ...
  constructor(
    ...
    this.route.params.subscribe(params => {
      ...
      this.permisosService.obtenerPermiso(this.permiso.id).then(respuesta => {
        ...
        this.formulario.controls["tipo"].setValue(respuesta.get("tipo"));
        this.formulario.controls["fechaVencimiento"].setValue(respuesta.get("fechaVencimiento"));
        this.formulario.controls["urlArchivo"].setValue(respuesta.get("urlArchivo"));
        this.formulario.controls["estado"].setValue(respuesta.get("estado"));
        this.formulario.controls["empresaId"].setValue(respuesta.get("empresaId"));
  ...
  editarPermisoFB() {
    this.permisosService.editarPermiso(this.permiso).then(_ => {
      this.mensajesService.mostrarMensaje("success", "Permiso editado con éxito", undefined);
